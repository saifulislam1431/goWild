...
const ProfileScreen = () => {
    ...
    const handlePress = (id) => {
        navigation.navigate('Costs', { id: id });
        refetch();
    };
    ...
    return (
        <ScrollView className="flex-1 h-full w-full">
            ...
            <View className="w-full h-64 -z-10 relative flex items-center justify-center -mt-16">
                <Image source={{ uri: "https://i.ibb.co/GJsBmTS/banner4.png" }} className="h-full w-full opacity-80" />
            </View>

            <View className="my-4">
                <Text className="text-center font-bold text-3xl text-[#8BD8EA]">Cost Expenses By Tour</Text>
            </View>
